...
public class DetectAndRecognize extends javax.swing.JFrame {
    ...
    private Hashtable<String, PersonData> allData;
    ...
    public DetectAndRecognize() throws IOException {
        ...
        allData = TrainData.buildFaceDBdata("C:\\Imgs\\Data.txt");
    ...
    CascadeClassifier faceDetector = new CascadeClassifier(DetectAndRecognize.class.getResource("haarcascade_frontalface_alt.xml").getPath().substring(1));
                ...
                while (runnable) {
                    if (webSource.grab()) {
                        try {
                            ...
                            Mat image_roi = null;
                            String fileNameWithMaxValueOnly = null;
                            if (rect_Crop != null) {
                            ...
                            if (fileNameWithMaxValueOnly == null) {
                                jTextField1.setText("");
                                jTextField2.setText("");
                                jTextField3.setText("");
                                jTextField4.setText("");
                                ...
                                jTextField2.setText(data.getAge());
                                jTextField3.setText(data.getPhone());
                                jTextField4.setText(data.getAddress());
...
//    private String GetDataBasedOnMostSimilarImage(BufferedImage image) {
//        SimilartyCompartior compartior = new SimilartyCompartior();
//        String fileNameWithMaxValueOnly = "";
//        File file2 = new File("C:\\Imgs\\compare.png");
//        try {
...
//        };
//           
//        File[] directoryListing = dir.listFiles(pngFilter);
//        
//        HashMap<String, Float> map = new HashMap<String, Float>();
//        if (directoryListing != null) {
//            for (File file1 : directoryListing) {
//                try {
//                    float comparsionResult = compartior.getMaxSimilartyResult(file1, file2);
//                    map.put(file1.getName(), comparsionResult);
//                } catch (IOException ex) {
//                    Logger.getLogger(DetectAndRecognize.class.getName()).log(Level.SEVERE, null, ex);
//                }
//            }
//
//            map.remove("compare.png");
//
...
//                    String fileNameWithMaxValue = entry.getKey();
//                    int iend = fileNameWithMaxValue.indexOf(".png");
//                    fileNameWithMaxValueOnly = fileNameWithMaxValue.substring(0, iend);
//                }
//            }
//        }
